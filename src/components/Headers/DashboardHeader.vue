  ...
  <component :is="navbarFixed ? 'a-affix' : 'div'" :offset-top="top">
    ...
    <a-layout-header>
      <a-row type="flex">
        ...
        <a-col :span="24" :md="12">
          <a-row type="flex">
            <a-button style="margin-right: 15px; margin-bottom: 10px" @click="goBack()" v-if="this.$route.name !== TextLocalization.Home[language]">{{ TextLocalization.Back[language] }}</a-button>
            <div>
              <!-- Header Breadcrumbs -->
              <Breadcrumbs/>
              ...
              <div class="ant-page-header-heading">
                <span class="ant-page-header-heading-title">{{ this.$route.meta.name }}</span>
              </div>
              <!-- / Header Page Title -->
            </div>
